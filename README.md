...
### `my_bot.py`
This is the file you will be writing your bot in

`my_bot.py` is the file that will be downloaded and run in the tournaments, so make sure the code in this file works!

You can add as many files as you want with different versions of your bot (or other participants bots) which can be useful to see if your improvements actually help
